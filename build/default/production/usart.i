...
void USARTHandleRxInt()
{
    ...
    {
        case '\r':
            if(SIM800L.uncomplete==1 && bufque==0){SIM800L.uncomplete=0;}
        break;
        case '\n':
            if(SIM800L.uncomplete==0) SIM800L.uncomplete=1;
            else
            {
                SIM800L.buffer[bufque]=0;
                SIM800L.uncomplete=0;

                if(SIM800L.buffer[0]=='+')
                {
                   if(SIM800L.buffer[1]=='C' && SIM800L.buffer[2]=='L' && SIM800L.buffer[3]=='I' )
                   {
                       uint8_t ci=8;
                       while(SIM800L.buffer[ci]!='\"' && (ci-8)<15)
                       {
                           SIM800L.cell[ci-8]=SIM800L.buffer[ci];
                           ci++;
                           SIM800L.cell_lenght++;
                       }
                       SIM800L.cell[ci-8]='\0';
                  ...
                  if(SIM800L.buffer[1]=='C' && SIM800L.buffer[2]=='M' && SIM800L.buffer[3]=='T' && SIM800L.buffer[4]=='I' )
                   {
                       uint8_t ci=12;
                       while(SIM800L.buffer[ci]>='0' && SIM800L.buffer[ci]<='9' )
                       {
                           SIM800L.smsmem[ci-12]=SIM800L.buffer[ci];
                           ci++;
                       }
                  ...
                  if(SIM800L.buffer[1]=='C' && SIM800L.buffer[2]=='S' && SIM800L.buffer[3]=='Q')
                   {
                     uint8_t ci=6;
                     while(SIM800L.buffer[ci]!=',' && (ci)<8)
                     {
                         SIM800L.csq[ci-6]=SIM800L.buffer[ci];
                         ci++;
                     }
                     SIM800L.csq[ci-6]=0;
                   }
                   ...
                   {
                     uint8_t ci=4;
                     while(SIM800L.buffer[ci]!='#' && (ci-4)<25)
                      {
                          SIM800L.command[ci-4]=SIM800L.buffer[ci];
                          ci++;
                      }
                     task=3;
                   }
                   if(SIM800L.buffer[1]=='C' && SIM800L.buffer[2]=='M' && SIM800L.buffer[3]=='G' && SIM800L.buffer[4]=='R')
                   {
                       ...
                       while(SIM800L.buffer[ci]!='\"' && SIM800L.cell_lenght<15 && end)
                        {
                            SIM800L.sender_cell[SIM800L.cell_lenght]=SIM800L.buffer[ci];
                            ci++;
                            SIM800L.cell_lenght++;
                        }
               ...
               else if(SIM800L.buffer[0]=='O' && SIM800L.buffer[1]=='K') SIM800L.ok=1;
                bufque=0;
             }
             SIM800L.busy=0;
         break;
