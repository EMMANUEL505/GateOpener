...
void main()
{
    ...
    EEPROMUpdateVersion("v1.3");
    password_empty[0]=0xFF; password_empty[1]=0xFF; password_empty[2]=0xFF; password_empty[3]=0xFF;
    if(EEPROMCheckPassword(password_empty))
    {
    ...
    while(1)
    {
        ...
        {
            case 0:
                if(RCSTAbits.OERR==1) {CREN=0;_delay((unsigned long)((200)*(32000000/4000000.0)));RCSTAbits.CREN=1; }
            ...
            case 1:
                ...
                {
                    LATAbits.LATA4=1; GPIOGreenLedBlink(5); ; LATAbits.LATA4=0;
                    LATCbits.LATC2=1;
                }
