...
void EepromStart()
{
    ...
    _delay((unsigned long)((4)*(32000000/4000000.0)));
    LATBbits.LATB6=0;
    _delay((unsigned long)((4/2)*(32000000/4000000.0)));
}
void EepromEnd()
{
    LATBbits.LATB6=0;
...
{
    int8_t i=0;
    LATCbits.LATC7=opcode>>1&0b00000001;
    _delay((unsigned long)((4/2)*(32000000/4000000.0)));
    LATBbits.LATB6=1;
    _delay((unsigned long)((4)*(32000000/4000000.0)));
    LATBbits.LATB6=0;
    ...
    LATCbits.LATC7=opcode&0b00000001;
    _delay((unsigned long)((4/2)*(32000000/4000000.0)));
    LATBbits.LATB6=1;
    _delay((unsigned long)((4)*(32000000/4000000.0)));
    LATBbits.LATB6=0;
    ...
    for(i=10;i>=0;i--)
    {
        LATCbits.LATC7=address>>i&0b00000001;
        _delay((unsigned long)((4/2)*(32000000/4000000.0)));
        LATBbits.LATB6=1;
        _delay((unsigned long)((4)*(32000000/4000000.0)));
        LATBbits.LATB6=0;
    ...
    while(!result && aux<((450*10)-10))
    {
        ...
        do{
            ...
            if(EepromRead(aux-count)==*(nmbr+nmbrLenght-(count+1)))
               ...
               {result=0;}
            count++;
        }while(result && count<nmbrLenght && count<10);
        aux=aux+10;
    }
    if(result==1)
    {
...
uint8_t EEPROMAdd(const char *nmbr, uint8_t nmbrLenght)
{
    ...
    do
    {
        aux=EepromRead((empty*10));
        if(aux<'0' || aux>'9')
        {
            found=1;
        }
        empty++;
    }while(!found&& empty<450);
...
void EEPROMUpdatePassword(const char *pass)
{
    EepromWrite(7900,*(pass));
    _delay((unsigned long)((5)*(32000000/4000.0)));
    EepromWrite(7901,*(pass+1));
    _delay((unsigned long)((5)*(32000000/4000.0)));
    EepromWrite(7902,*(pass+2));
    _delay((unsigned long)((5)*(32000000/4000.0)));
    EepromWrite(7903,*(pass+3));
    _delay((unsigned long)((5)*(32000000/4000.0)));
}

void EEPROMUpdateVersion(const char *ver)
{
    EepromWrite(7904,*(ver));
    _delay((unsigned long)((5)*(32000000/4000.0)));
    EepromWrite(7905,*(ver+1));
    _delay((unsigned long)((5)*(32000000/4000.0)));
    EepromWrite(7906,*(ver+2));
    _delay((unsigned long)((5)*(32000000/4000.0)));
    EepromWrite(7907,*(ver+3));
    _delay((unsigned long)((5)*(32000000/4000.0)));
}
...
uint8_t EEPROMCheckPassword(const char *pass)
{
    password[0]=EepromRead(7900);
    password[1]=EepromRead(7901);
    password[2]=EepromRead(7902);
    password[3]=EepromRead(7903);
